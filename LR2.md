...
```
### Результат:
  ![Меню](https://github.com/SergUdav/PI/blob/LR2/pic/2.png)
...
```
### Результат:
  ![Меню](https://github.com/SergUdav/PI/blob/LR2/pic/3.1.png)
  ![Меню](https://github.com/SergUdav/PI/blob/LR2/pic/3.2.png)
...
```
### Результат:
  ![Меню](https://github.com/SergUdav/PI/blob/LR2/pic/4.png)
...
```
### Результат:
  ![Меню](https://github.com/SergUdav/PI/blob/LR2/pic/5.png)
...
```
### Результат:
  ![Меню](https://github.com/SergUdav/PI/blob/LR2/pic/6.png)
...
```
### Результат:
  ![Меню](https://github.com/SergUdav/PI/blob/LR2/pic/7.png)
...
```
### Результат:
  ![Меню](https://github.com/SergUdav/PI/blob/LR2/pic/8.png)
...
```
### Результат:
  ![Меню](https://github.com/SergUdav/PI/blob/LR2/pic/9.png)
...
```
### Результат:
  ![Меню](https://github.com/SergUdav/PI/blob/LR2/pic/10.png)
